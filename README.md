...
Once the `conda-forge` channel has been enabled, `dwave-networkx` can be installed with:

```
conda install dwave-networkx
```

It is possible to list all of the versions of `dwave-networkx` available on your platform with:
